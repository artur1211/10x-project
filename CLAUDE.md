...
- After each change use: npm run build, npx tsc, npm run lint:fix, npm run format to veryfi the code
...
- Follow a **unified service pattern** in the service layer where related operations are grouped together.
